...
if (isset($_SESSION['felhaszmail'])) { //Amennyiben a seisson tartalma nem üres
    ...
    ?>
        ...
        <h2>RAM - árukészlet kezelése</h2>

        <form action="ram.php" method="post">    

        <input type="text" name="ID" placeholder="ID">
        <input type="text" name="name" placeholder="Név">
        <input type="text" name="type" placeholder="pl: ddr4=4; ddr3=3">
        <input type="text" name="gb" placeholder="Méret (GB)">
        <input type="text" name="mhz" placeholder="MHz">
    ...
    if (isset($_POST['gomb1'])) { 
        ...
        if($name && $type && $gb && $mhz && $piece && $descrip && $pricehuf && $barcode && $picture != ""){
            $sq = "INSERT INTO ram (name,type,gb,mhz,piece,descrip,pricehuf,barcode,picture) VALUES ('$name','$type','$gb','$mhz','$piece','$descrip','$pricehuf','$barcode','$picture')";
    ...
    if (isset($_POST['gomb2'])) { 
        ...
        if ($id !="") {
        $sq = "DELETE FROM ram WHERE ID = '$id' ";
    ...
    if (isset($_POST['gomb3'])) { 
        $name = $_POST["name"];
            ...
            $sq ="SELECT * FROM ram WHERE (name) LIKE ('%".$name."%')";
            $leker = $db_connect->query($sq);
                    ...
                    <?php
                        ...
                        ?>
                            ...
                            <tr>
                                ...
                                <th style="background-color:white"><br><?php echo($row["gb"]); ?></th>
                                <th style="background-color:white"><br><?php echo($row["mhz"]); ?></th>

...
if (isset($_SESSION['felhaszmail'])) { //Amennyiben a seisson tartalma nem üres
    ...
    ?>
        ...
        <h2>Tápegység - árukészlet kezelése</h2>

        <form action="tapegyseg.php" method="post">    

        <input type="text" name="ID" placeholder="ID">
        <input type="text" name="name" placeholder="Név">
        <input type="text" name="watt" placeholder="Teljesítmény/W">
        <input type="text" name="pins" placeholder="PIN-ek száma">
    ...
    if (isset($_POST['gomb1'])) { 
        ...
        if($name && $watt && $pins && $descrip && $piece && $pricehuf && $barcode && $picture != ""){
            $sq = "INSERT INTO pwrsupply (name,watt,pins,descrip,piece,pricehuf,barcode,picture) VALUES ('$name','$watt','$pins','$descrip','$piece','$pricehuf','$barcode','$picture')";
    ...
    if (isset($_POST['gomb2'])) { 
        ...
        if ($id !="") {
        $sq = "DELETE FROM pwrsupply WHERE ID = '$id' ";
    ...
    if (isset($_POST['gomb3'])) { 
        $name = $_POST["name"];
            ...
            $sq ="SELECT * FROM pwrsupply WHERE (name) LIKE ('%".$name."%')";
            $leker = $db_connect->query($sq);
                    ...
                    <?php
                        ...
                        ?>
                            ...
                            <tr>
                                ...
                                <th style="background-color:white"><br><?php echo($row["watt"]); ?></th>
                                <th style="background-color:white"><br><?php echo($row["pins"]); ?></th>
